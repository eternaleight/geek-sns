...
const style = {
  share: `border-[0.9px] border-gray-500 w-full max-xs:h-[15 0px] h-[170px] shadow-[3px_7px_13px_-22px] mb-2 rounded-[10px]`,
  shareWrapper: `p-[10px]`,
  shareTop: `flex items-center`,
  shareInput: ` border-none w-full bg-[#1e2028] focus:outline-none text-white`,
  shareHr: `m-[20px]`,
